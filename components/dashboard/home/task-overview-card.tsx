...
export function TaskOverviewCard({ task }: { task: TaskDisplay }) {
    ...
    return (
        <Link
            ...
            className="block group bg-white p-4 rounded-lg border border-slate-100 shadow-sm hover:shadow-md transition-all duration-200"
        >
            ...
            <h3 className="text-slate-800 font-semibold mb-3 group-hover:text-[#3B8E8E] transition-colors line-clamp-2">
                {task.title}
            </h3>
